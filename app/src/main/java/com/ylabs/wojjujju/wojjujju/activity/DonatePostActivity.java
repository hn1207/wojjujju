...
//
        ...
        if (beautySelectedItemArrayList.size() > 0) {
            beautySelectedItemListView.setAdapter(new BaseRecyclerAdapter(beautySelectedItemArrayList, DonatePostActivity.this, R.layout.items_select_goods_item));
        }
        ...
        findViewById(R.id.date_pick).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(DonatePostActivity.this, BeautyPickDateActivity.class));
