    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.complete).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(ShopPaymentActivity.this, BeautyPaymentCompleteActivity.class));
                finish();
            }
        });
    }
...
//        LinearLayoutManager layoutManager = new LinearLayoutManager(BeautyPaymentActivity.this);
        ...
        if (paymentItemArrayList.size() > 0) {
            paymentListView.setAdapter(new BaseRecyclerAdapter(paymentItemArrayList, ShopPaymentActivity.this, R.layout.items_beauty_payment_item));
        }
