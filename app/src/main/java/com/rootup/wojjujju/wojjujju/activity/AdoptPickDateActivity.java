...
public class AdoptPickDateActivity extends AppCompatActivity implements DatePickerListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_adopt_pick_date);
...
//        dateTimeList.add(new String("24:00"));
        ...
        LinearLayoutManager layoutManager = new LinearLayoutManager(AdoptPickDateActivity.this);
        layoutManager.setOrientation(LinearLayoutManager.HORIZONTAL);

        if (dateTimeList.size() > 0) {
            dateTimeListView.setAdapter(new BaseRecyclerAdapter(dateTimeList, AdoptPickDateActivity.this, R.layout.items_date_time_picker_item));
        }
