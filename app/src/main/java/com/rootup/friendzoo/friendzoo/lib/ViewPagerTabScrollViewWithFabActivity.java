 ...
 */
public class ViewPagerTabScrollViewWithFabActivity extends BaseActivity implements ObservableScrollViewCallbacks {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.lib_activity_viewpagertab);
...
//        mToolbarView = findViewById(R.id.toolbar);
        ...
        slidingTabLayout.setCustomTabView(R.layout.lib_tab_indicator, android.R.id.text1);
        slidingTabLayout.setSelectedIndicatorColors(getResources().getColor(R.color.mint));
...
//                args.putInt(ViewPagerTabScrollViewFragment.ARG_SCROLL_Y, mScrollY);
                args.putInt(ViewPagerTabScrollViewWithFabFragment.ARG_SCROLL_Y, mScrollY);
