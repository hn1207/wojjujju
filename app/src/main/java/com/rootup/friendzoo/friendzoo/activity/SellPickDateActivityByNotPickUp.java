...
public class SellPickDateActivityByNotPickUp extends AppCompatActivity implements DatePickerListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sell_pick_date_by_not_pickup);
...
//        dateTimeList.add(new String("24:00"));
        ...
        LinearLayoutManager layoutManager = new LinearLayoutManager(SellPickDateActivityByNotPickUp.this);
        layoutManager.setOrientation(LinearLayoutManager.HORIZONTAL);

        if (dateTimeList.size() > 0) {
            dateTimeListView.setAdapter(new BaseRecyclerAdapter(dateTimeList, SellPickDateActivityByNotPickUp.this, R.layout.items_date_time_picker_item));
        }
